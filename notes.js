...
const NOTES = [
  ...
  { id: "005", type: "text", text: "We always have fun together, no matter what we are doing."},
  { id: "006", type: "text", text: "Our dreams for the future are the same 🏠👨‍👩‍👧‍👦✈️🌅🌊"},
  { id: "007", type: "text", text: "How you always hold my hand, wherever we are."},
  ...
  { id: "011", type: "text", text: "You inspire me to improve myself."},
  ...
  { id: "019", type: "text", text: ""},
  { id: "020", type: "text", text: ""},
  { id: "021", type: "text", text: ""},
  { id: "022", type: "text", text: ""},
  { id: "023", type: "text", text: ""},
  { id: "024", type: "text", text: ""},
  { id: "025", type: "text", text: ""},
  { id: "026", type: "text", text: ""},
